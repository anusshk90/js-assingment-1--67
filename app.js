...
// // }
// // else if (parseInt(character)>= 65 & parseInt(character)<= 90)
// // {
// //     document.write(character + "  is Upper Case ")
// // }
// // else if (parseInt(character)>= 97 & parseInt(character)<= 122)
// // {
// //     document.write(character + "  is  Lower Case")
// // }
...
// // Task - 9 g) 
// // StrtLoc = +prompt("Enter your starting  index : ")
// // NoOFLOc = +prompt("How many colors do you want to delete : ")
// // colorName.splice(StrtLoc, NoOFLOc);
...
// // ==============================================================================
// //                      Chapter - 38 - 44 Functions & Switch Cases while Loop
// // ==============================================================================
...
//     alert("Wrelcome to my Mobile Service")
...
//     ChangeImage.src = 'images/no2.jpg';

// }

// function Mouseout() {
//     ChangeImage = document.getElementById('img1')
//     ChangeImage.src = 'images/no1.jpg';
...
// function Increase() {
//     count++;
//     Inc = document.getElementById('INDEC')
...
// // Task 1
// var theads = document.getElementById('thh')

// function addDataOnly() {
...
//     Password = document.getElementById('ps')
//     ConfrmPass = document.getElementById('cp')
...
//     tn1 = document.createTextNode(Name.value)
//     tn2 = document.createTextNode(Email.value)
//     tn3 = document.createTextNode(Phone.value)
//     tn4 = document.createTextNode(Password.value)
//     tn5 = document.createTextNode(ConfrmPass.value)
...
//     ConfrmPass = document.getElementById('Cpass')
...
//     tn4 = document.createTextNode(Password.value)
//     tn5 = document.createTextNode(ConfrmPass.value)
//     DelBtnTn = document.createTextNode("Remove")
//     EditBtnTn = document.createTextNode("Edit")
...
//     th4.appendChild(tn4)
//     th5.appendChild(tn5)
//     Delbtn.appendChild(DelBtnTn)
//     Editbtn.appendChild(EditBtnTn)
...
// var images = ["images/img1.png.", "images/img2.jpg", "images/img3.png", "images/img4.jpg"]
